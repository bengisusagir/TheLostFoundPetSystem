...
class AllReportsPage(tk.Tk):
    def __init__(self,user_id):
        ...
        self.create_menu()
        self.create_table_layoutForAll()
        self.create_table_layoutForUser()
    ...
    def create_table_layoutForAll(self):
    ...
    def create_table_layoutForUser(self):
        # Ana sayfa içerik bölgesi
        content_frame = tk.Frame(self)
        content_frame.pack(fill="both", expand=True, padx=10, pady=10)
        ...
        row_num = 1  # Satır başlatma
        reportInfo = self.db.get_reports_by_user()
    ...
    def my_reports(self):
        MyReportsPage(self,self.user_id)
